...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, F(0), KC_RALT, F(0), F(0), KC_RCTL, KC_RCTL),
    ...
    // layout 3 for pcb light and layout
	LAYOUT(
		KC_GRV, F(2), F(3), KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_DEL,
